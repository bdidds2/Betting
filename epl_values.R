...
epl_gt2 <- epl_data %>%
  ...
  tab_spanner(label = "Values",
              spanners = c("away_ml", "home_ml", "away_dc", "home_dc", "btts_yes", "btts_no")) %>%
  ...
  tab_style(style = cell_borders(sides = "right", style = "solid"),
            locations = list(cells_body(columns = c(7, 11, 15, 19, 23, 27)),
                             cells_column_labels(columns = c(7, 11, 15, 19, 23, 27)))) %>%
  tab_style(style = cell_borders(sides = "right", style = "solid", weight = px(3)),
            locations = list(cells_body(columns = c(5, 9, 13, 17, 21, 25, 29)),
                             cells_column_labels(columns = c(5, 9, 13, 17, 21, 25, 29)))) %>%
  ...
  tab_header(paste0("EPL ", result1), subtitle = epl_dates) %>%
...
gtsave(epl_gt2, 
       expand = 30, filename = "EPL.png", vheight = 100, vwidth =4000)
